...
Although the world average is going up (the blue line) there is still large variation
between countries. Note that in earlier years fewer countries provided data so there is
likely to be some bais in the plots above.

# Conclusions

```{r worldConclusions, echo=FALSE}
# This will return a single value by using [, pctWiP].
